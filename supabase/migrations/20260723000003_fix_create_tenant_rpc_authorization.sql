-- Update create_tenant_with_subscription to enforce super_admin authorization check at the start of the SECURITY DEFINER function
...
DECLARE
    ...
    v_result JSONB;
BEGIN
    -- AUTHORIZATION CHECK: must be first, before any other logic
